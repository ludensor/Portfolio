...
#include "EQSNavSampleEnvQueryGenerator_TriangleTessellation.generated.h"
...
class EQSNAVSAMPLE_API UEQSNavSampleEnvQueryGenerator_TriangleTessellation : public UEnvQueryGenerator_ProjectedPoints
{
	GENERATED_BODY()

public:
	UEQSNavSampleEnvQueryGenerator_TriangleTessellation(const FObjectInitializer& ObjectInitializer);
